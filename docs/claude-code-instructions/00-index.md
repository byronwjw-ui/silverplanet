...
打开 [`FULL-INSTRUCTION.md`](./FULL-INSTRUCTION.md)，全选复制，粘贴给 Claude Code。它会读完全部 12 大模块的上下文。

然后说一句：

> 请从「第十一部分：实现顺序」的**阶段一**开始，按顺序实现。每完成一个阶段告诉我，我测试通过后再继续下一个阶段。
...
| 06 | [ai-chat-core](./06-ai-chat-core.md) | AI 陪聊核心实现 + 「银花」人格 System Prompt |
